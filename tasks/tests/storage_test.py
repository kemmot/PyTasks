...
class EditFormatterTests(unittest.TestCase):
    def test_format_correct(self):
        ...
        expected_output_lines.append('# lines beginning with ''#'' will be ignored')
        ...
        expected_output_lines.append('# key: value')
        ...
        expected_output_lines.append('# yyyy-MM-dd HH:mm:ss: annotation comment')
